...
export class Speakers extends APIResource {
  ...
  search(query?: SpeakerSearchParams, options?: Core.RequestOptions): Core.APIPromise<SpeakerSearchResponse>;
  search(options?: Core.RequestOptions): Core.APIPromise<SpeakerSearchResponse>;
  search(
    query: SpeakerSearchParams | Core.RequestOptions = {},
    options?: Core.RequestOptions,
  ): Core.APIPromise<SpeakerSearchResponse> {
...
export type SpeakerSearchResponse = Array<Speaker>;
